...
// nestedFunction is inside of myFunction. In this case nestedFunction is the inner function reaching into the outer function to access the internal variable which is considered closure. In inner function can reach out, but the outer function cannot reach in. 
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const popTotal = array.reduce(function(accumulator, item){
